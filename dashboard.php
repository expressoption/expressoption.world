  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" target="_blank">
        <img src="soft-ui-dashboard-main\assets\img\logo-ct-dark.png" class="navbar-brand-img h-100" alt="main_logo" style="width: 50px;;">
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/withdrawl.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1">Withdrawl/Send</span>
          </a>
        </li>
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="&#128276 cursor-pointer"></i>
              </a>
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <h3 class="text-white font-weight-bolder mb-0 mt-3">$<?php echo number_format($balance, 2); ?></h3>
<span class="text-white text-sm">Main Balance</span>
                    ...
                    <div class="col-4">
                      ...
                      <!-- <p class="text-white text-sm text-end font-weight-bolder mt-auto mb-0" style="color: green;">+0%</p> -->
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <span class="text-white text-sm">Last Profit Made</span>
                    </div>
                    <div class="col-4">
...
<!-- TradingView Widget END -->
            <div class="card-footer pt-0 p-3 d-flex align-items-center">
              ...
              <div class="w-40 text-end">
                <a class="btn btn-dark mb-0 text-end" href="pricelist.html">Fund Your Trade Account</a>
              </div>
            </div>
          </div>
        </div>
